...
namespace WSTowerApi.Contexts
{
    public partial class WSTowerApiContext : DbContext
    {
        public WSTowerApiContext()
        {
        }

        public WSTowerApiContext(DbContextOptions<WSTowerApiContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasIndex(e => e.Apelido)
                    .HasName("UQ__Usuario__571DBAE633473B7B")
                    .IsUnique();

                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuario__A9D10534F84BBC3F")
                    .IsUnique();
